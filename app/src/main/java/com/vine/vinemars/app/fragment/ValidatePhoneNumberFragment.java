 ...
 */
public class ValidatePhoneNumberFragment extends DialogFragment implements View.OnFocusChangeListener, NetworkRequestListener<User>, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public static ValidatePhoneNumberFragment newInstance() {
    ...
    public static ValidatePhoneNumberFragment newInstance(Bitmap background) {
        ValidatePhoneNumberFragment fragment = newInstance();
